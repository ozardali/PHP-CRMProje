 ...
 ?>
		...
		jQuery(document).ready(function($)
		{
			...
			setTimeout(function()
			{
				...
				toastr.success("En gelişmiş CRM sistemini kullanıyorsunuz. Keyfini çıkarın!", "Neon CRM Sistem", opts);
			}, 3000);
...
$query = mysql_query("SELECT COUNT(*) FROM u_uyeler");
...
?>" data-postfix="" data-duration="1500" data-delay="0">0</div>
					...
					<p>sistemi aktif kullanan sayısı.</p>
				</div>
...
?>" data-postfix="" data-duration="1500" data-delay="600">0</div>
					...
					<p>bugün giriş yapılan hesap sayısı.</p>
				</div>
			...
			<div class="col-sm-3 col-xs-6">
				...
				<div class="tile-stats tile-blue">
					...
					<div class="num" data-start="0" data-end="<?php
$query = mysql_query("SELECT COUNT(*) FROM a_iletisim");
$say = mysql_fetch_array($query);
	
echo $say[0];
?>" data-postfix="" data-duration="1500" data-delay="1800">0</div>
		
					<h3>İletişim İsteği</h3>
					<p>iletişim istek sayısı.</p>
				</div>
			...
			<div class="col-sm-8">
				...
				<div class="panel panel-primary" id="charts_env">
					...
					<div class="panel-heading">
						<div class="panel-title">Giriş İstatistikleri</div>
		
					
					</div>
					<?php
$query_listele = "SELECT * FROM u_girislog order by giris_id DESC limit 10";
...
$durum = $row_listele['giris_durum']; 
if($durum == 1)
{
	$renk = "#4eee94";
	
	$durumbilgi = "Başarılı Giriş <i class='fa fa-check'></i>";
}
else{
	$renk = "#eea2ad";
	$durumbilgi = "Başarısız Giriş <i class='fa fa-ban'></i>";
}

			?> 
						<tr bgcolor=<?php echo $renk; ?>>
							  <td><?php echo $sayi; ?></td>
					   <td ><?php echo $row_listele['giris_yapan']; ?></td>
                        <td><?php echo $row_listele['giris_ip']; ?></td>
                        <td ><?php echo $row_listele['giris_tarihi']; ?></td>
                        <td><?php echo $durumbilgi; ?></td>
						</tr> <?php } while ($row_listele = mysql_fetch_assoc($listele)); ?>  </tbody>
    ...
    <?php } // Show if recordset empty ?>
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<div class="panel-title">
							...
							Sunucu Bilgileri
								<br />
								<small>anlık sunucu kullanımı</small>
							</h4>
						</div>
		...
		<div class="row">
			...
			<div class="col-sm-8">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<div class="panel-title">Son Kaydolan 3 Kullanıcı</div>
					...
					<table class="table table-bordered table-responsive">
						...
						<tbody>
							<tr>
								<td>1</td>
								<td>Göksel Özardalı</td>
								<td>gokselozardali@gmail.com</td>
								<td class="text-center">2016-10-13 00:01:13	</td>
							</tr>
